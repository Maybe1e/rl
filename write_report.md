...
训练过程显示出清晰的阶段性特征。在约前100,000步，episode长度从初始的约5步快速增长到约55步，智能体快速学会了沿三角形第一条边移动并命中路径点。在100,000至400,000步之间，episode长度稳定在55至58步，智能体基本掌握了从顶角到底角的连续运动，但底角附近的精度仍有波动。在400,000步之后，策略质量趋于稳定，DTW指标收敛至0.029至0.034的范围。

最终训练结果在10次独立评估中全部达成46/46路径点访问（100%成功率），平均仅需57步完成所有路径点。考虑到共有46个目标路径点且顺序追踪要求每个路径点被依次命中，57步意味着智能体几乎没有浪费任何步骤——每约1.2步就命中一个新路径点。
...
| `results/fig1_trajectory.png` | 轨迹评估图 |
| `results/fig2_metrics.png` | 定量指标图 |
